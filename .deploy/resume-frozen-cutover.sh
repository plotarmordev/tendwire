...
readonly RELEASE_ID=9026d9bc-7446533-3659994-r5
...
readonly PREVIOUS_RELEASE=/home/smith/.local/share/acp-runtime/releases/9026d9bc-7446533-3659994-r4
readonly PREVIOUS_RUNTIME=/home/smith/.local/share/tendwire-runtime/acp-7446533-3659994-r4
readonly PREVIOUS_MANIFEST=/home/smith/.local/share/acp-runtime/manifests/9026d9bc-7446533-3659994-r4.json
...
readonly PRIVATE_ENV=/home/smith/.config/herdres/frozen-7446533-3659994-r5.env
readonly PREVIOUS_PRIVATE_ENV=/home/smith/.config/herdres/frozen-7446533-3659994-r4.env
readonly PREVIOUS_VALIDATION=${TRANSACTION_ROOT}/release-validation.r4.json
readonly PREVIOUS_VALIDATION_SHA256=e49440edb8ff59f84c649b71372fd26914caa9ef57f425727be9a09fa43cffda
readonly CHAIN_VALIDATION=${TRANSACTION_ROOT}/release-validation.r3.json
readonly CHAIN_VALIDATION_SHA256=e41fec9a5ae040197c43734858782edea5ba95faa54249d231abdc130840992c
readonly OLDER_VALIDATION=${TRANSACTION_ROOT}/release-validation.r2.json
readonly OLDER_VALIDATION_SHA256=f9150a0bf106cee8e3c59ad3c3164ee21f98d7bfbc57115f1ae26ecebbcbfb66
...
assert_older_validation_file() {
    assert_validation_file "$1" "${OLDER_VALIDATION_SHA256}"
}
...
rebind_forward_release() {
    ...
    assert_older_validation_file "${OLDER_VALIDATION}"
