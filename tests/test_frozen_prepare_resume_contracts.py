...
def test_resume_rebinds_only_from_the_verified_stopped_previous_release() -> None:
    ...
    assert 'readonly PREVIOUS_VALIDATION=${TRANSACTION_ROOT}/release-validation.r3.json' in source
    assert 'readonly CHAIN_VALIDATION=${TRANSACTION_ROOT}/release-validation.r2.json' in source
